...
# What is the name of this app?
	define('APP_NAME', 'Stay In Text');  

# When email is sent out from the server, where should it come from?
# Ideally, this should match the domain name
	define('APP_EMAIL', 'notification@dontforgetyourcrayons.org'); 
...
*/ 	
	define('SYSTEM_EMAIL', 'admin-message@dontforgetyourcrayons.org'); 

# Default DB name for this app
	define('DB_NAME', 'p2_dontforgetyourcrayons_org'); 
...
# For extra security, you might want to set different salts than what the core uses
	//define('PASSWORD_SALT', 'gasjdg73ye93y2h2oi');
	//define('TOKEN_SALT', 'iuhfewiuew743i3iu');